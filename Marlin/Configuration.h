...
#define STRING_CONFIG_H_AUTHOR "(Sal Sodano, Hybrid Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BigBox Hybrid Pro"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 70, 240, 10 }
