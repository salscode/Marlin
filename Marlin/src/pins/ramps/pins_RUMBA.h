...
//
  ...
  #else
    #define TEMP_0_PIN                        10  // Analog Input (default connector for thermistor *T0* on rumba board is used) E3D-PT100
  #endif
#endif
  ...
  #else
    #define TEMP_1_PIN                         9  // Analog Input (default connector for thermistor *T1* on rumba board is used) E3D-PT100
  #endif
#endif
